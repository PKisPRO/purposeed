    ...
    <section className="bg-cream py-20 md:py-28">
      <div className="mx-auto max-w-6xl px-6 sm:px-8">
        <SectionHeading
          ...
          subtitle="From profile building and admissions strategy to STEM competitions, case-based learning, study tours, and pre-university readiness, purposeedu helps students grow with direction."
        />
